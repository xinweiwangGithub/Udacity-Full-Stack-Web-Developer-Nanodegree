...
pursuit_of_happyness= media.Movie("The Pursuit of Happyness",
                                  "The film features Will Smith as Gardner, a homeless salesman. Smith's son Jaden Smith co-stars, making his film debut as Gardner's son, Christopher Jr.",
                                  "https://upload.wikimedia.org/wikipedia/en/8/81/Poster-pursuithappyness.jpg",
                                  "https://www.youtube.com/watch?v=SIZKoak6gp8")

harry_potter = media.Movie("Harry Potter I",
...
forrest_gump = media.Movie("Forrest Gump",
                           "The story depicts several decades in the life of Forrest Gump, a slow-witted and naive, but good-hearted and athletically prodigious man from Alabama who witnesses, and in some cases influences, some of the defining events of the latter half of the 20th century in the United States",
...
american_beauty = media.Movie("American Beauty",
                              ...
                              "https://www.youtube.com/watch?v=4qVv7xg-uDY&oref=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3D4qVv7xg-uDY&has_verified=1")

monalisa_smile = media.Movie("Mona Lisa Smile",
                             "Katherine Ann Watson (Julia Roberts), a 30-year-old graduate student in the department of Art History at Oakland State, takes a position teaching 'History of Art' at Wellesley College, a conservative women's private liberal arts college in Massachusetts, because she wants to make a difference and influence the next generation of women.",
...
movies = [pursuit_of_happyness, harry_potter, forrest_gump, shawshank_redemption, american_beauty, monalisa_smile]
